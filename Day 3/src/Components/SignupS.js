...
export default function SignupS() {
  ...
  const formHandler = (event) => {
    ...
    if (username.length === 0 || name.length === 0 || email.length === 0 || password.length === 0 || conpassword.length === 0 || password !== conpassword) 
    {
    ...
    return (
      <div>
      <img className='upbg' src='https://img.freepik.com/free-photo/volumetric-musical-background-with-treble-clef-notes-generative-ai_169016-29575.jpg' alt='bg' ></img>
